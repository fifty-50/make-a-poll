	...
	<nav class="navbar is-warning" role="navigation" aria-label="main navigation">
		...
		<div id="navbar" class="navbar-menu">
			<div class="navbar-start">
    	  		...
    	  		<a class="navbar-item" href="recent.php" style="background-color: #FBFBFB;color: red"><span class="icon"><i class="fas fa-history"></i></span>&nbsp;Recent polls</a>
  	...
  	<div class="columns">
    	...
    	<div class="column">
    		<?php
			    ...
			    $result=mysqli_query($conn,"SELECT ID, CreationTime, Question, Options, ExpiryTime, Votes, Private, VoteLimit FROM polls WHERE Private=0 ORDER BY polls.ID DESC");
